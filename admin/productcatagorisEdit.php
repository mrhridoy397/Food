...
$data = $productcatagoris->productcatagorisedit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $productcatagoris->productcatagorisUpdate($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="productcatagorisIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="productCatagoris" class="form-control form-control-user" placeholder="Product Catagoris" name="productCatagoris" required autofocus value="<?php if (isset($_POST['productCatagoris'])){ echo $_POST['productCatagoris'];} else { echo $data['productCatagoris'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="productcatagorisIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

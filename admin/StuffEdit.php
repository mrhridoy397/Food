                                        ...
                                        <div class="tile-body">
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" id="description" class="form-control " cols="30" rows="3"><?php if(isset($_REQUEST['description']))  { echo $__REQUEST['description'];} else{echo $data['description'];}?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
